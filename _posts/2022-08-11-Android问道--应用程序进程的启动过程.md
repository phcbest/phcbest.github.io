...
在ZygoteInit.ZygoteInit方法中会调用一个native方法`ZygoteInit.nativeZygoteInit();`,在AndroidRuntime.cpp的**JNINativeMethod**数组中我们看到了nativeZygoteInit对应的函数是**com_android_internal_os_ZygoteInit_nativeZygoteInit** ` const JNINativeMethod methods[] = {{ "nativeZygoteInit", "()V",(void*) com_android_internal_os_ZygoteInit_nativeZygoteInit },};`
